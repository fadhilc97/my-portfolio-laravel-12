<x-layouts.blog>
  <div class="w-3/4 bg-white mx-auto">
    ...
    <section class="space-y-12 bg-primary px-32 py-16">
      <a href="/blog" class="inline-block text-2xl text-tertiary font-medium">&lt; <span class="ml-4">Back to
          blog posts</span></a>
      <h1 class="font-stack-sans-notch font-medium text-quatenary">Blog Title</h1>
      <h3 class="leading-10 text-quatenary/70">Lorem ipsum dolor sit amet consectetur adipisicing elit.
        Nesciunt ex quasi
        dolorum
        fugiat,
        commodi voluptates
    ...
    <section class="px-32 py-16">
      <p class="text-primary/70 text-xl leading-10">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde
        aperiam,
    ...
    {{-- Footer --}}
    <section class="px-32 py-12 space-y-12 text-center">
      <p class="text-xl text-primary/70">How much did you like this article?</p>
      <div class="space-y-2">
        <p class="text-xl text-tertiary font-medium">100</p>
        <button type="button"
